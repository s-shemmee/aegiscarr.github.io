    ...
    ! function(r) {
        ...
        t.exports = function(t, n, r, e, i, o, u) {
            ...
            if (b && (a = M(b.call(new t))) !== Object.prototype && a.next && (O(a, l, !0), _ || "function" == typeof a[P] || m(a, P, A)), h && g && g.name !== F && (p = !0, y = function values() {
                    return g.call(this)
                }), _ && !u || !I && !p && v[P] || m(v, P, y), w[n] = y, w[l] = A, i)
                if (c = {
                        values: h ? y : s(F),
                        keys: o ? y : s("keys"),
                        entries: d
        ...
        t.exports = !i || r(4)(function() {
            ...
            for (var r = y(t), e = arguments.length, i = 1, o = v.f, u = g.f; i < e;)
                for (var c, f = d(arguments[i++]), a = o ? p(f).concat(o(f)) : p(f), s = a.length, l = 0; l < s;) c = a[l++], h && !u.call(f, c) || (r[c] = f[c]);
            return r
        } : i
    }, function(t, n, i) {
        var r = i(3),
        ...
        r(62)("split", 2, function(i, o, g, y) {
            ...
            return d = "c" == "abbc" [u](/(b)*/)[1] || 4 != "test" [u](/(?:)/, -1)[p] || 2 != "ab" [u](/(?:ab)*/)[p] || 4 != "." [u](/(.?)(.?)/)[p] || 1 < "." [u](/()()/)[p] || "" [u](/.?/)[p] ? function(t, n) {
                ...
                for (var e, i, o, u = [], c = 0, f = n === Jt ? E : n >>> 0, a = new RegExp(t.source, (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : "") + "g");
                    (e = l.call(a, r)) && !(c < (i = a[v]) && (u.push(r.slice(c, e.index)), 1 < e[p] && e.index < r[p] && h.apply(u, e.slice(1)), o = e[0][p], c = i, f <= u[p]));) a[v] === e.index && a[v]++;
